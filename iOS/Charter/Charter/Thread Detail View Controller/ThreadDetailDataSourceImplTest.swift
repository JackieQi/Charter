...
func constructEmails() -> [Email] {
    ...
    e1.subject = "Thread"
    e1.from = "Matt"
    e1.date = Calendar.currentCalendar().dateFromComponents(dateComponents)!
    ...
    e2.date = Calendar.currentCalendar().dateFromComponents(dateComponents)!
    ...
    e3.date = Calendar.currentCalendar().dateFromComponents(dateComponents)!
    ...
    e4.date = Calendar.currentCalendar().dateFromComponents(dateComponents)!
...
class ThreadDetailDataSourceImplTest: XCTestCase {
    ...
    func testCellConstruction() {
        ...
        let cell1 = dataSource.tableView(tableView, cellForRowAtIndexPath: IndexPath(forRow: 0, inSection: 0)) as! FullEmailMessageTableViewCell
        ...
        let cell2 = dataSource.tableView(tableView, cellForRowAtIndexPath: IndexPath(forRow: 1, inSection: 0)) as! FullEmailMessageTableViewCell
        ...
        let cell3 = dataSource.tableView(tableView, cellForRowAtIndexPath: IndexPath(forRow: 2, inSection: 0)) as! FullEmailMessageTableViewCell
        ...
        let cell4 = dataSource.tableView(tableView, cellForRowAtIndexPath: IndexPath(forRow: 3, inSection: 0)) as! FullEmailMessageTableViewCell
